...
- Bei Docker-API-Kompatibilitätsproblemen kann `TRAEFIK_DOCKER_API_VERSION` angepasst werden.
...
- `TRAEFIK_DOCKER_API_VERSION`: Docker API-Version für Traefik (Standard `1.41`)
